 ...
 * extension point.
 */
public class MyNewWizard extends Wizard {
	private static final String CATEGORY_SEPARATOR = "/"; //$NON-NLS-1$

	private String categoryId = null;

	private MyNewWizardSelectionPage mainPage;
	...
	public void addPages() {
		...
		System.out.println("catafgoryid"+categoryId);
		mainPage = new MyNewWizardSelectionPage(workbench, selection, root,
